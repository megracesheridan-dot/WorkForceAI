  ...
  return (
    <div className="relative h-[420px] w-full max-w-md">
      ...
      <motion.div
        ...
        className="relative z-10 rounded-2xl border border-border-strong bg-surface/90 p-5 shadow-2xl backdrop-blur"
      >
      ...
      <motion.div
        ...
        className="absolute -left-6 bottom-6 z-10 flex items-center gap-2 rounded-full border border-border-strong bg-surface px-3.5 py-2 shadow-xl"
      >
      ...
      <motion.div
        ...
        className="absolute -right-4 -top-4 z-10 flex items-center gap-2 rounded-full border border-border-strong bg-surface px-3.5 py-2 shadow-xl"
      >
      ...
      <motion.div
        ...
        className="absolute -right-8 bottom-24 z-10 flex items-center gap-2 rounded-full border border-border-strong bg-surface px-3.5 py-2 shadow-xl"
      >
